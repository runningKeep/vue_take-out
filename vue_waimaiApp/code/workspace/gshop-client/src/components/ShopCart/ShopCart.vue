<template>
  <div>
    <div class="shopcart" @click="showCartFoods()">
      <div class="content">
        ...
        <div class="content-right" v-if="!totalCount">
          <div class="pay not-enough" >20￥起送</div>
        </div>
        <div class="content-right" v-else>
          <div class="pay not-enough" v-if="totalPrice<20">{{'差￥'+(20-totalPrice)+'起送' }}  </div>
